    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("role", models.CharField(choices=[("staff", "Staff"), ("approver_level_1", "Approver Level 1"), ("approver_level_2", "Approver Level 2"), ("finance", "Finance")], default="staff", max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("proforma", models.FileField(blank=True, null=True, upload_to=procurement.models.proforma_upload_path)),
                ("purchase_order_file", models.FileField(blank=True, null=True, upload_to=procurement.models.po_upload_path)),
                ("purchase_order_metadata", models.JSONField(blank=True, default=dict)),
                ("receipt", models.FileField(blank=True, null=True, upload_to=procurement.models.receipt_upload_path)),
