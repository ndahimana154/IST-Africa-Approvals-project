  ...
  return (
    <section className="mx-auto max-w-3xl space-y-6">
      <div className="glass-panel p-8">
        <p className="text-sm uppercase tracking-wide text-slate-500">New request</p>
        <h2 className="text-3xl font-semibold text-slate-900">Capture procurement needs</h2>
        <p className="text-slate-500">Include clear descriptions so approvers can sign off faster.</p>
